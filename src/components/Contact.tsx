      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    <a href="mailto:developer@example.com" className="hover:text-blue-600 dark:hover:text-blue-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm">
            ...
            {submitMessage && (
              <div className={`mb-6 p-4 rounded-md ${submitError ? 'bg-red-50 text-red-700 dark:bg-red-900/30 dark:text-red-400' : 'bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-400'}`}>
                {submitMessage}
              </div>
            )}
