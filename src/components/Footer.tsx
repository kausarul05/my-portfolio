  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/#skills" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                  Skills
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col items-center">
