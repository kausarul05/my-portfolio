        ...
        >
          <div className="md:w-1/2 md:pr-12">
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              I craft responsive, user-friendly applications using MongoDB, Express, React, and Node.js. Let&apos;s turn your vision into reality.
            </motion.p>
          ...
          >
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
              ...
              <motion.div 
                className="absolute inset-4 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 opacity-80 flex items-center justify-center overflow-hidden"
                    ...
                    <div className="relative flex items-center justify-center w-full h-full">
                      <motion.span 
                        ...
                        transition={{ 
                          ...
                          rotate: { duration: 2, delay: 1.5, repeat: Infinity, repeatDelay: 1 }
                        }}
                      >
                        👨‍💻
                      </motion.span>
